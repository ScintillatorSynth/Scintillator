...
TEST(AbstractVGenTest, DuplicateParameterNames) {
    AbstractVGen dupIn("dupIn", { "in1", "in1" }, { AbstractVGen::kFloat, AbstractVGen::kFloat }, { "out" },
                       { { 1, 1 } }, { { 1 } }, "@out = @in1 + @in1;");
    ...
    AbstractVGen inCrossOut("inCrossOut", { "cross" }, { AbstractVGen::kFloat }, { "cross" }, { { 1 } }, { { 1 } },
                            "@cross = @cross;");
...
TEST(AbstractVGenTest, ReservedParameterNames) {
    AbstractVGen timeInput("timeInput", { "time" }, { AbstractVGen::kFloat }, { "out" }, { { 1 } }, { { 1 } },
                           "@out = @time;");
...
TEST(AbstractVGenTest, UnknownParameterNames) {
    ...
    AbstractVGen absentInputParam("absentiInputParam", { "a" }, { AbstractVGen::kFloat }, { "out" }, { { 1, 1 } },
                                  { { 1 } }, "@out = @time * (@a + @b);");
    EXPECT_FALSE(absentInputParam.prepareTemplate());
    EXPECT_FALSE(absentInputParam.valid());

    AbstractVGen noOutputParam("absentOutputParam", { "a" }, { AbstractVGen::kFloat }, {}, { { 1 } }, { {} },
                               "@out = 1.0f;");
...
TEST(AbstractVGenTest, ParameterizeInvalid) {
    ...
    AbstractVGen mismatch("mistmatchInput", { "in1", "in2" }, { AbstractVGen::kFloat, AbstractVGen::kFloat }, { "out" },
...
TEST(AbstractVGenTest, ParameterizeValid) {
    ...
    AbstractVGen passthrough("passthrough", { "in" }, { AbstractVGen::kFloat }, { "out" }, { { 1 } }, { { 1 } },
                             "@out = @in;");
    ...
    AbstractVGen moreComplex("moreComplex", { "freq", "phase", "mul", "add" },
                             { AbstractVGen::kFloat, AbstractVGen::kFloat, AbstractVGen::kFloat, AbstractVGen::kFloat },
                             { "out" }, { { 1, 1, 1, 1 } }, { { 4 } },
